...
<h2><a href="<%=request.getContextPath()%>/pc/home.do" target="_parent">老麻师</a> >> ${sub.sname}</h2> 
        ...
        <div class="mainc">
            ...
            <div class="maincList">
                <ol>
                     ...
                     <c:forEach items="${topics}" var="top" varStatus="vs"> 
		 
                    <li>
                        <a href="<%=request.getContextPath()%>/pc/detail.do?tid=${top.tid}"  class="clear">
